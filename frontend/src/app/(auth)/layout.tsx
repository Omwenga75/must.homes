  ...
  return (
    <div className="min-h-screen flex bg-[#f0f2f5]">
      ...
      <div className="hidden lg:flex lg:flex-1 flex-col bg-white relative overflow-hidden">
        ...
        {/* Image collage — top right, not overlapping text */}
        <div className="absolute top-0 right-0 w-[55%] h-[58%] pointer-events-none z-10">
          ...
          {/* Floating Emoji 1 */}
          <div className="absolute top-6 left-4 w-14 h-14 rounded-full bg-white shadow-xl flex items-center justify-center text-2xl animate-bounce z-20" style={{ animationDuration: '3s' }}>
            🎉
          </div>

          {/* Floating Emoji 2 */}
          <div className="absolute bottom-4 right-6 w-12 h-12 rounded-full bg-white shadow-xl flex items-center justify-center text-xl z-20">
            💖
          </div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-emerald-50 rounded-full blur-[120px] -z-0 -translate-x-1/3 translate-y-1/3" />
      </div>
